...
for head,tail in zip(range(int(len(minimal_assignment[0])/2)), range(int(len(minimal_assignment[1])/2))):
    tmp1_ul = tmp1_ul.append( list_heads[head] )
    tmp1_ul = tmp1_ul.append( list_tails[tail] )
...
for head,tail in zip(range(int(len(minimal_assignment[0])/2)), range(int(len(minimal_assignment[1])/2))):
    tmp1_ll = tmp1_ll.append( list_heads[head] )
    tmp1_ll = tmp1_ll.append( list_tails[tail] )
...
for head,tail in zip(range(int(len(minimal_assignment[0])/2)), range(int(len(minimal_assignment[1])/2))):
    tmp2_ul = tmp2_ul.append( list_heads[head] )
    tmp2_ul = tmp2_ul.append( list_tails[tail] )   
...
for head,tail in zip(range(int(len(minimal_assignment[0])/2)), range(int(len(minimal_assignment[1])/2))):
    tmp2_ll = tmp2_ll.append( list_heads[head] )
    tmp2_ll = tmp2_ll.append( list_tails[tail] )   
