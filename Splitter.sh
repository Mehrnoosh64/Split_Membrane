...
########################################################################################
# This script generates a split membrane out of a membrane created with CHARMM36 FF.   #       
...
# Read the .gro file (default is the gro file created by Charmm-gui: step7_10.gro, you can use any other .gro file.)
...
echo "Runing a short minimization"
